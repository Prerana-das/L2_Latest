<template>
    <div class="container">
        <form v-on:submit.prevent>
            ...
            <div class="form-group">
                <label for="exampleInputEmail2">Quantiy</label>
                <input type="number" class="form-control" v-model="form.quantity" id="exampleInputEmail2" aria-describedby="emailHelp" placeholder="" >
            </div>
...
export default {
    ...
    methods:{
        async formSubmit(){
            ...
            if(this.form.quantity == '') return this.i("Product quantity is empty!")
            if(this.form.category_id == '') return this.i("Product category is empty!")
